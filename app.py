...
# recipients mapping
recipients = {
    "deonne_ramsey@trimble.com": ("Deonne Ramsey", "Trimble Inc."),
    "valeria_tupan@trimble.com": ("Valeria Tupan", "Trimble Inc."),
    "dragan_mamic@trimble.com": ("Dragan Mamic", "Trimble Inc."),
    "sravani_kalidindi@trimble.com": ("Sravani Kalidindi", "Trimble Inc."),
    "manjubhargavi.thota@trimble.com": ("Manju Thota", "Trimble Inc."),
    "chung_jonghoon@trimble.com": ("Chung Jonghoon", "Trimble Inc."),
    "ms_harish@trimble.com": ("Harish", "Trimble Inc."),
    "chester_perkins@trimble.com": ("Chester Perkins", "Trimble Inc."),
    "marc_geffray@trimble.com": ("Marc Geffray", "Trimble Inc."),
    "ajie.pamadaraji@trimble.com": ("Ajie Pamadaraji", "Trimble Inc."),
    "jeffrey_smith@trimble.com": ("Jeffrey Smith", "Trimble Inc."),
    "thiyagarajan_renganathan@trimble.com": ("Thiyagarajan Renganathan", "Trimble Inc."),
    "ramya_thangamani@trimble.com": ("Ramya Thangamani", "Trimble Inc."),
    "surya_shekar@trimble.com": ("Surya Shekar", "Trimble Inc."),
    "manikandan_a@trimble.com": ("Manikandan A", "Trimble Inc."),
    "nicole_elkins@trimble.com": ("Nicole Elkins", "Trimble Inc."),
    "josephine_shirleyregina@trimble.com": ("Josephine Regina", "Trimble Inc."),
    "ajay_permal@trimble.com": ("Ajay Permal", "Trimble Inc."),
    "roxana_ailoaie@trimble.com": ("Roxana Ailoaie", "Trimble Inc."),
    "yasmany_hernandez@trimble.com": ("Yasmany Hernandez", "Trimble Inc."),
    "raluca_lapusneanu@trimble.com": ("Raluca Lapusneanu", "Trimble Inc.")
}
